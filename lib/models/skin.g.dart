...
_$SnakeSkinImpl _$$SnakeSkinImplFromJson(
  ...
  boostTint: (json['boostTint'] as List<dynamic>?)
      ?.map((e) => const ColorConverter().fromJson((e as num).toInt()))
      .toList(),
  texture: (json['texture'] as List<dynamic>).map((e) => e as String).toList(),
  size: const Vector2Converter().fromJson(json['size'] as Map<String, dynamic>),
  price: (json['price'] as num).toInt(),
);

Map<String, dynamic> _$$SnakeSkinImplToJson(
  _$SnakeSkinImpl instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'boostTint': instance.boostTint?.map(const ColorConverter().toJson).toList(),
