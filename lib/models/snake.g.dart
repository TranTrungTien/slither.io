...
_$SnakeEntityImpl _$$SnakeEntityImplFromJson(
  Map<String, dynamic> json,
) => _$SnakeEntityImpl(
  id: json['id'] as String,
  name: json['name'] as String,
  head: const Vector2Converter().fromJson(json['head'] as Map<String, dynamic>),
  angle: (json['angle'] as num).toDouble(),
  desiredAngle: (json['desiredAngle'] as num).toDouble(),
  score: (json['score'] as num).toInt(),
  boost: json['boost'] as bool,
  tracers: (json['tracers'] as List<dynamic>)
      .map((e) => const Vector2Converter().fromJson(e as Map<String, dynamic>))
      .toList(),
  ...
  previousDropPosition: _$JsonConverterFromJson<Map<String, dynamic>, Vector2>(
    json['previousDropPosition'],
    const Vector2Converter().fromJson,
  ),
);

Map<String, dynamic> _$$SnakeEntityImplToJson(
  _$SnakeEntityImpl instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  ...
  'previousDropPosition': _$JsonConverterToJson<Map<String, dynamic>, Vector2>(
    instance.previousDropPosition,
